      ...
      <section className="bg-gray-50 dark:bg-gray-800 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <ul className="list-disc pl-5 space-y-4 text-gray-700 dark:text-gray-300">
            <li>
              Recipient of University Grants Commissions (Govt. Of India) fellowship (JRF) for meritorious students in science (2008-2011).
            </li>
            <li>
              Student Fellowship Award for Participation in N2010 (5th International Nitrogen Conference 3 – 7 December 2010, New Delhi, INDIA).
            </li>
            <li>
            ...
            <li>
              Top Reviewer Award (Multidisciplinary Category) 2017 by Publons.
            </li>
            <li>
              Top Reviewer's Award (Assorted Category) 2018 by Publons.
            </li>
            <li>
              Marquis Who’s Who in the World (2014-2020 Editions).
            </li>
            <li>
              Research Fellow, INTI International University, Malaysia.
            </li>
            <li>
              Member of the "Post Graduate Committee for Admissions and Research" at Department of Biological Sciences, King Abdulaziz University (2017-till date).
            </li>
            <li>
              Member of the "Committee for Examining Scientific Thesis and Detecting Plagiarism” at Department of Biological Sciences, King Abdulaziz University (2021-till date).
            </li>
            <li>
              Member of the standing committee "BIO-110 (Biology at Graduate Level course)" at King Abdulaziz University (2019-2020).
            </li>
            <li>
              Fellow, the Royal Society of Biology, London, UK (2020).
            </li>
            <li>
            ...
            <li>
              Member, Research Advisory Committee, Govt. Degree College Mendhar, University of Jammu, India.
            </li>
          </ul>
        </div>
      </section>
